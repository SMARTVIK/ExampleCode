...
public class CircleIndicator extends IndicatorShape {
    ...
    public CircleIndicator(Context context, int indicatorSize, boolean mustAnimateChanges) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            setBackground(ResourcesCompat.getDrawable(context.getResources(), R.drawable.indicator_circle_unselected, null));
        } else {
            setBackgroundDrawable(context.getResources().getDrawable(R.drawable.indicator_circle_unselected));
        }
    }
